...
This is more exploratory but maybe easier to understand - statified
models
...
```
    ...
    ##   term        estimate std.error statistic p.value
    ##   <chr>          <dbl>     <dbl>     <dbl>   <dbl>
    ## 1 (Intercept)    49.9      18.3       2.72 0.00671
    ## 2 stars           4.91      4.10      1.20 0.231  
    ## 
    ## [[2]]
    ## # A tibble: 2 x 5
    ##   term        estimate std.error statistic p.value
    ##   <chr>          <dbl>     <dbl>     <dbl>   <dbl>
    ## 1 (Intercept)     18.1     26.3      0.688 0.492  
    ## 2 stars           15.8      5.63     2.81  0.00506
    ## 
    ## [[3]]
    ## # A tibble: 2 x 5
    ##   term        estimate std.error statistic  p.value
    ##   <chr>          <dbl>     <dbl>     <dbl>    <dbl>
    ## 1 (Intercept)    -11.3     14.5     -0.784 4.33e- 1
    ## 2 stars           28.0      3.10     9.02  2.13e-19
    ## 
    ## [[4]]
    ## # A tibble: 2 x 5
    ##   term        estimate std.error statistic  p.value
